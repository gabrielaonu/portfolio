...
$styles = array(
	...
	'section' => array(
		...
		'miscellaneous' => array(
			...
			'z-index' => array(
				'title'			=> 'Z-Index',
				'help'			=> 'The z-index defines the stack order of your elements. An element with greater stack order is always in front of an element with a lower stack order. You only need to define this if you, for example, give an element a negative margin and it gets hidden behind another element.',
				'size'			=> 'span2',
				'data-input-type' 	=> 'range-slider',
				'data-target'	=> '.content-block',
				'default'		=> 1,
	...
	'cover' => array(
		...
		'cover-effects' => array(
			...
			'image_effect' => array(
				...
				'data-handler' => 'default',
				'default'		 	=> 'none',
				'help'				=> 'For displacement maps, the background position will be fixed to \'Middle Center\', overriding any background position you set yourself. A repeated background image or a background video will not work for displacement maps.',
				'data-visibility-switch' 	=> true,
