...
<script id="ep-post-options-template" type="text/template">
	...
	<div class="option">
		<div class="option-inner">
			<div class="attribute span4">
				<h4>Classes</h4>
				<input type="text" name="post_custom_class" class="editor-listen" data-handler="epPostOptions" value="{{custom_class}}" placeholder="Classes" data-content-id="{{contentId}}" data-post-id="{{postId}}">
			</div>
		</div>
	</div>
</script>
	...
	<div class="option">
		<div class="option-inner">
			<div class="attribute span3">
				...
				<input type="text" name="profile_username" class="editor-listen" data-handler="socialProfileOptions" value="{{username}}" placeholder="{{usernamePrefix}}" data-content-id="{{contentId}}" data-profile="{{profile}}">
			</div>
		</div>
	</div>
	<div class="option">
